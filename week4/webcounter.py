...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 19 18:35:45 2017
...
def run(url,w1,w2): 
    ...
    for i in freq:
        if freq[i]>w1_counter and freq[i]<w2_counter:
            word_set.add(i)
...
if __name__=='__main__':
    print(run('http://tedlappas.com/wp-content/uploads/2016/09/textfile.txt','Enormous','Amazon'))
