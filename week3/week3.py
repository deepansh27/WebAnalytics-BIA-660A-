...
def run(path):
    ...
    negLex=loadLexicon('/Users/deepanshparab/Desktop/Fall-2017-Cources/BIA-660A/WebAnalytics-BIA-660A-/week3/negative-words.txt')
...
if __name__ == "__main__": 
    reviews,decisions=run('/Users/deepanshparab/Desktop/Fall-2017-Cources/BIA-660A/WebAnalytics-BIA-660A-/week3/textfile')
